...
import type { DeviceItem, HistoryEvent, BreadcrumbItem } from "types";
...
export default function DeviceDetail({
  item,
  history,
  breadcrumbs, // ✅ รับ breadcrumbs จาก page.tsx
}: {
  item: DeviceItem;
  ...
  // columns ของ tab (type-safe ตรงกับ DeviceSoftwareRow)
  const columns = React.useMemo(
    () => [
      ...
      { header: "Status",       accessor: (r: DeviceSoftwareRow) => r.status ?? "Active" },
    ],
    []
  );
  ...
  return (
    <DetailView
      ...
      installationTabLabel="Bundled Software" // ⭐ ปรับชื่อแท็บได้
      breadcrumbs={breadcrumbs}               // ✅ ส่ง breadcrumbs ให้ Header
      info={{
        left: [
